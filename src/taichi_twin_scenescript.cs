...
public class taichi_twin_scenescript : MonoBehaviour
{
	...
	public taichi_twin_scenescript()
	{
		...
		this.settingFileDir = "Taichi/TwinViewer Settings/";
		this.curFacial = 1;
		this.animReplay = true;
		this.playOnceFlg = true;
		this.resourcesPathFull = "Assets/Taichi Character Pack/Resources/Taichi";
	...
	{
		this.viewCam = (taichi_twin_viewscript)GameObject.Find("Main Camera").GetComponent("taichi_twin_viewscript");
	...
	public virtual void OnGUI()
	{
		...
		taichi_twin2nd_scenescript taichi_twin2nd_scenescript = (taichi_twin2nd_scenescript)this.gameObject.GetComponent("taichi_twin2nd_scenescript");
		if (this.guiSkin)
		{
		...
		{
			this.guiOn = flag;
			taichi_twin2nd_scenescript.guiOn = flag;
		}
		...
		else
		{
			...
			{
				this.timerReset();
				taichi_twin2nd_scenescript.timerReset();
			}
			if (GUI.Button(new Rect((float)(Screen.width / 2 - 150), (float)(Screen.height - 40), (float)300, (float)30), "Reset"))
			{
				...
				this.SetAnimationSpeed(this.animSpeed);
				taichi_twin2nd_scenescript.sliderReset();
			}
	...
	public virtual void SetSettings(int _i)
	{
		...
		{
			this.resourcesPathFull = "Assets/Taichi Character Pack/Resources/Taichi";
			this.resourcesPath = "Taichi/";
			this.animationPath = "Taichi/Animations Legacy/m01@";
			this.CharacterCode = "M01/";
			this.AnimationListFile = "animation_list";
			this.AnimationListFileAll = "animation_list";
			path = "Taichi/TwinViewer Settings/" + this.CharacterCode + "fbx_ctrl";
			this.faceMat_L = (Material)Resources.Load("Taichi/Materials/m01_face_00_l", typeof(Material));
			this.faceMat_M = (Material)Resources.Load("Taichi/Materials/m01_face_00_m", typeof(Material));
		...
		{
			this.resourcesPathFull = "Assets/HonokaFutabaBasicSet/Resources/Honoka";
			this.resourcesPath = "Honoka/";
			this.animationPath = "Honoka/Animations Legacy/f01@";
			this.AnimationListFile = "animation_list";
			this.AnimationListFileAll = "animation_list_all";
			...
			this.functionList["facial"] = false;
			this.functionList["lod"] = true;
			this.faceMat_L = (Material)Resources.Load("Honoka/Materials/f01_face_00_l", typeof(Material));
			this.faceMat_M = (Material)Resources.Load("Honoka/Materials/f01_face_00_m", typeof(Material));
			this.curCharacterName = "Honoka Futaba";
		}
		else if (_i == 3)
		{
			this.resourcesPathFull = "Assets/Aoi Character Pack/Resources/Aoi";
			this.resourcesPath = "Aoi/";
			this.animationPath = "Aoi/Animations Legacy/f02@";
			this.AnimationListFile = "animation_list";
			this.AnimationListFileAll = "animation_list_all";
			...
			this.functionList["facial"] = false;
			this.functionList["lod"] = true;
			this.faceMat_L = (Material)Resources.Load("Aoi/Materials/f02_face_00_l", typeof(Material));
			this.faceMat_M = (Material)Resources.Load("Aoi/Materials/f02_face_00_m", typeof(Material));
		...
		{
			this.resourcesPathFull = "Assets/Satomi Character Pack/Resources/Satomi";
			this.resourcesPath = "Satomi/";
			this.animationPath = "Satomi/Animations Legacy/f05@";
			this.AnimationListFile = "animation_list";
			this.AnimationListFileAll = "animation_list_all";
			this.CharacterCode = "F05/";
			path = this.settingFileDir + this.CharacterCode + "fbx_ctrl";
			this.faceMat_L = (Material)Resources.Load("Satomi/Materials/f05_face_00_l", typeof(Material));
			this.faceMat_M = (Material)Resources.Load("Satomi/Materials/f05_face_00_m", typeof(Material));
			this.functionList["model"] = true;
			this.functionList["facial"] = false;
			this.functionList["lod"] = true;
	...
	public virtual void playAnimation()
	{
		...
		GameObject exists = (GameObject)Resources.Load(this.animationPath + this.curAnimName);
		if (exists)
		{
			if (this.playOnceFlg)
			{
		...
		else
		{
			this.SetNextModel(-1);
			this.SetNextModel(1);
			MonoBehaviour.print(this.curAnimName + " animation clip does not exist");
		}
