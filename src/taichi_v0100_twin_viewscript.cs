...
[Serializable]
public class taichi_v0100_twin_viewscript : MonoBehaviour
{
	...
	public taichi_v0100_twin_viewscript()
	{
		this.mode = "rote";
		this.x = 180f;
		this.y = 30f;
	...
	public virtual void CameraRote(float _x, float _y)
	{
		...
		this.y = taichi_v0100_twin_viewscript.ClampAngle(this.y, this.yMinLimit, this.yMaxLimit);
	}
