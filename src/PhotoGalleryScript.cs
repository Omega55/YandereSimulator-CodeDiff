...
public class PhotoGalleryScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $GetPhotos$1410 : GenericGenerator<WWW>
	{
		internal PhotoGalleryScript $self_$1415;

		public $GetPhotos$1410(PhotoGalleryScript self_)
		{
			this.$self_$1415 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new PhotoGalleryScript.$GetPhotos$1410.$(this.$self_$1415);
		}
	}
	...
	{
		return new PhotoGalleryScript.$GetPhotos$1410(this).GetEnumerator();
	}
