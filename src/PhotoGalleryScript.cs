...
public class PhotoGalleryScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $GetPhotos$2622 : GenericGenerator<WWW>
	{
		internal PhotoGalleryScript $self_$2627;

		public $GetPhotos$2622(PhotoGalleryScript self_)
		{
			this.$self_$2627 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new PhotoGalleryScript.$GetPhotos$2622.$(this.$self_$2627);
		}
	}
	...
	{
		return new PhotoGalleryScript.$GetPhotos$2622(this).GetEnumerator();
	}
