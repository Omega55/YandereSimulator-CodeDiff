...
public class PhotoGalleryScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $GetPhotos$1382 : GenericGenerator<WWW>
	{
		internal PhotoGalleryScript $self_$1387;

		public $GetPhotos$1382(PhotoGalleryScript self_)
		{
			this.$self_$1387 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new PhotoGalleryScript.$GetPhotos$1382.$(this.$self_$1387);
		}
	}
	...
	{
		return new PhotoGalleryScript.$GetPhotos$1382(this).GetEnumerator();
	}
