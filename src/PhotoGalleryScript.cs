...
public class PhotoGalleryScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $GetPhotos$1412 : GenericGenerator<WWW>
	{
		internal PhotoGalleryScript $self_$1417;

		public $GetPhotos$1412(PhotoGalleryScript self_)
		{
			this.$self_$1417 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new PhotoGalleryScript.$GetPhotos$1412.$(this.$self_$1417);
		}
	}
	...
	{
		return new PhotoGalleryScript.$GetPhotos$1412(this).GetEnumerator();
	}
