...
public class PhotoGalleryScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $GetPhotos$3097 : GenericGenerator<WWW>
	{
		internal PhotoGalleryScript $self_$3102;

		public $GetPhotos$3097(PhotoGalleryScript self_)
		{
		...
		{
			return new PhotoGalleryScript.$GetPhotos$3097.$(this.$self_$3102);
		}
	}
	...
	{
		return new PhotoGalleryScript.$GetPhotos$3097(this).GetEnumerator();
	}
