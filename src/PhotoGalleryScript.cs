...
public class PhotoGalleryScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $GetPhotos$2234 : GenericGenerator<WWW>
	{
		internal PhotoGalleryScript $self_$2239;

		public $GetPhotos$2234(PhotoGalleryScript self_)
		{
		...
		{
			return new PhotoGalleryScript.$GetPhotos$2234.$(this.$self_$2239);
		}
	}
	...
	{
		return new PhotoGalleryScript.$GetPhotos$2234(this).GetEnumerator();
	}
