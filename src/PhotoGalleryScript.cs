...
public class PhotoGalleryScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $GetPhotos$2692 : GenericGenerator<WWW>
	{
		internal PhotoGalleryScript $self_$2697;

		public $GetPhotos$2692(PhotoGalleryScript self_)
		{
		...
		{
			return new PhotoGalleryScript.$GetPhotos$2692.$(this.$self_$2697);
		}
	}
	...
	{
		return new PhotoGalleryScript.$GetPhotos$2692(this).GetEnumerator();
	}
