...
public class GateScript : MonoBehaviour
{
	...
	public virtual void Update()
	{
		...
		if (!this.Closed)
		{
			this.GateCollider.localScale = Vector3.Lerp(this.GateCollider.localScale, new Vector3((float)0, (float)0, (float)0), Time.deltaTime * (float)10);
		...
		{
			this.GateCollider.localScale = Vector3.Lerp(this.GateCollider.localScale, new Vector3((float)1, (float)1, (float)1), Time.deltaTime * (float)10);
