...
public class YandereScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $ApplyCustomCostume$2705 : GenericGenerator<WWW>
	{
		internal YandereScript $self_$2720;

		public $ApplyCustomCostume$2705(YandereScript self_)
		{
			this.$self_$2720 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new YandereScript.$ApplyCustomCostume$2705.$(this.$self_$2720);
		}
	}
	...
	public virtual void Update()
	{
		...
		if (!this.PauseScreen.Show)
		{
			...
			if (this.LaughIntensity < (float)10)
			{
				...
				{
					if (this.PickUp != null && this.CarryAnimID == this.ID && !this.Mopping && !this.Dipping && !this.Pouring && !this.BucketDropping)
					{
			...
			if (this.Armed)
			{
				...
				while (this.ID < Extensions.get_length(this.ArmedAnims))
				{
					...
					{
						this.CharacterAnimation[this.ArmedAnims[2]].weight = (float)0;
					}
					this.ID++;
				}
			}
	...
	{
		return new YandereScript.$ApplyCustomCostume$2705(this).GetEnumerator();
	}
