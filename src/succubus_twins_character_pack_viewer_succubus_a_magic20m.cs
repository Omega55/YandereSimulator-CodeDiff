...
[Serializable]
public class succubus_twins_character_pack_viewer_succubus_a_magic20m : MonoBehaviour
{
	...
	public succubus_twins_character_pack_viewer_succubus_a_magic20m()
	{
	...
	public virtual void setParticle()
	{
		if (!this.GetComponent<Animation>().IsPlaying("succubus_a_magic_01"))
		{
			...
			UnityEngine.Object.Instantiate(Resources.Load("Samples/ParticleGenerate Prefab/magic_particle20m_instance"), new Vector3((float)0, (float)0, (float)0), Quaternion.identity);
		}
	}
