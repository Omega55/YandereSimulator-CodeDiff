...
[Serializable]
public class succubus_twins_character_pack_viewer_succubus_b_magic4m : MonoBehaviour
{
	...
	public succubus_twins_character_pack_viewer_succubus_b_magic4m()
	{
	...
	public virtual void setParticle()
	{
		if (!this.GetComponent<Animation>().IsPlaying("succubus_b_magic_01"))
		{
			...
			UnityEngine.Object.Instantiate(Resources.Load("Samples/ParticleGenerate Prefab/magic_particle4m_instance"), new Vector3((float)0, (float)0, (float)0), Quaternion.identity);
		}
	}
