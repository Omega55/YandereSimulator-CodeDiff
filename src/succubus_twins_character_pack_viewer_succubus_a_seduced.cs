...
[Serializable]
public class succubus_twins_character_pack_viewer_succubus_a_seduced : MonoBehaviour
{
	...
	public succubus_twins_character_pack_viewer_succubus_a_seduced()
	{
	...
	public virtual void Update()
	{
		...
		this.GetComponent<Animation>().Play("succubus_a_death_lp");
