							...
							if (Input.GetButton("Y"))
							{
								...
								if (this.Circle.fillAmount <= (float)0)
								{
									...
									if (this.Size == 1)
									{
										...
										{
											if (this.Yandere.EquippedID == this.Yandere.Item1ID)
											{
												if (this.Yandere.Item2ID > 0)
												{
													gameObject = (GameObject)UnityEngine.Object.Instantiate(this.Yandere.WeaponPickups[this.Yandere.Item1ID], this.Yandere.RightHand.position, Quaternion.identity);
													this.Yandere.Item1Name = this.Name;
													this.Yandere.Item1Type = this.Type;
													this.Yandere.Item1ID = this.ID;
												}
												else
												{
													this.Yandere.Item2Name = this.Name;
													this.Yandere.Item2Type = this.Type;
													this.Yandere.Item2ID = this.ID;
												}
											}
											else if (this.Yandere.EquippedID == this.Yandere.Item2ID)
											{
												gameObject = (GameObject)UnityEngine.Object.Instantiate(this.Yandere.WeaponPickups[this.Yandere.Item2ID], this.Yandere.RightHand.position, Quaternion.identity);
												this.Yandere.Item2Name = this.Name;
												this.Yandere.Item2Type = this.Type;
												this.Yandere.Item2ID = this.ID;
											}
											...
											else
											{
												...
												else if (this.Yandere.Item2ID > 0)
												{
													this.Yandere.Item2Name = this.Name;
													this.Yandere.Item2Type = this.Type;
													this.Yandere.Item2ID = this.ID;
										...
										else if (this.Yandere.Item1ID > 0)
										{
											this.Yandere.Item2Name = this.Name;
											this.Yandere.Item2Type = this.Type;
											this.Yandere.Item2ID = this.ID;
									...
									else if (this.Yandere.Armed && this.Yandere.EquippedSize > 1)
									{
										if (this.Yandere.EquippedType != 3)
										{
											gameObject = (GameObject)UnityEngine.Object.Instantiate(this.Yandere.WeaponPickups[this.Yandere.EquippedID], this.Yandere.RightHand.position, Quaternion.identity);
									...
									if (gameObject != null)
									{
										...
										float num6 = eulerAngles.y = y;
										Vector3 vector3 = gameObject.transform.eulerAngles = eulerAngles;
									}
									...
									this.ControllerInventoryPanel.UpdateSprites();
									this.Yandere.Armed = true;
									this.Yandere.Weapons[this.Yandere.EquippedID].active = true;
