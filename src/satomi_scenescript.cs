...
public class satomi_scenescript : MonoBehaviour
{
	...
	public satomi_scenescript()
	{
		...
		this.facialMatName = "f05_face_00";
		this.viewerResourcesPath = "Satomi";
	...
	public virtual void Start()
	{
		...
		this.viewCam = (satomi_viewscript)GameObject.Find("Main Camera").GetComponent("satomi_viewscript");
