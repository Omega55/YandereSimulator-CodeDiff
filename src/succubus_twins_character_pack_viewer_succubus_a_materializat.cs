...
[Serializable]
public class succubus_twins_character_pack_viewer_succubus_a_materialization : MonoBehaviour
{
	public virtual void Update()
	{
		if (!this.GetComponent<Animation>().IsPlaying("succubus_a_appear_float"))
		{
	...
	public virtual void setParticle()
	{
		if (!this.GetComponent<Animation>().IsPlaying("succubus_a_appear_float"))
		{
			...
			this.GetComponent<Animation>().CrossFade("succubus_a_appear_float");
