...
public class HomeYandereScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $ApplyCustomCostume$1253 : GenericGenerator<WWW>
	{
		internal HomeYandereScript $self_$1260;

		public $ApplyCustomCostume$1253(HomeYandereScript self_)
		{
			this.$self_$1260 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new HomeYandereScript.$ApplyCustomCostume$1253.$(this.$self_$1260);
		}
	}
	...
	{
		return new HomeYandereScript.$ApplyCustomCostume$1253(this).GetEnumerator();
	}
