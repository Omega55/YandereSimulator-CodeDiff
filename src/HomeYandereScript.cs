...
public class HomeYandereScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $ApplyCustomCostume$1229 : GenericGenerator<WWW>
	{
		internal HomeYandereScript $self_$1236;

		public $ApplyCustomCostume$1229(HomeYandereScript self_)
		{
			this.$self_$1236 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new HomeYandereScript.$ApplyCustomCostume$1229.$(this.$self_$1236);
		}
	}
	...
	{
		return new HomeYandereScript.$ApplyCustomCostume$1229(this).GetEnumerator();
	}
