...
public class HomeYandereScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $ApplyCustomCostume$3064 : GenericGenerator<WWW>
	{
		internal HomeYandereScript $self_$3070;

		public $ApplyCustomCostume$3064(HomeYandereScript self_)
		{
			this.$self_$3070 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new HomeYandereScript.$ApplyCustomCostume$3064.$(this.$self_$3070);
		}
	}

	[CompilerGenerated]
	[Serializable]
	internal sealed class $ApplyCustomFace$3071 : GenericGenerator<WWW>
	{
		internal HomeYandereScript $self_$3076;

		public $ApplyCustomFace$3071(HomeYandereScript self_)
		{
			this.$self_$3076 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new HomeYandereScript.$ApplyCustomFace$3071.$(this.$self_$3076);
		}
	}
	...
	{
		return new HomeYandereScript.$ApplyCustomCostume$3064(this).GetEnumerator();
	}

	public virtual IEnumerator ApplyCustomFace()
	{
		return new HomeYandereScript.$ApplyCustomFace$3071(this).GetEnumerator();
	}
