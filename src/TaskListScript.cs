...
public class TaskListScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $UpdateTaskInfo$2132 : GenericGenerator<WWW>
	{
		internal TaskListScript $self_$2138;

		public $UpdateTaskInfo$2132(TaskListScript self_)
		{
		...
		{
			return new TaskListScript.$UpdateTaskInfo$2132.$(this.$self_$2138);
		}
	}
	...
	{
		return new TaskListScript.$UpdateTaskInfo$2132(this).GetEnumerator();
	}
