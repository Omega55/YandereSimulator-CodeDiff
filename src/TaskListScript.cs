...
public class TaskListScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $UpdateTaskInfo$2178 : GenericGenerator<WWW>
	{
		internal TaskListScript $self_$2184;

		public $UpdateTaskInfo$2178(TaskListScript self_)
		{
			this.$self_$2184 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new TaskListScript.$UpdateTaskInfo$2178.$(this.$self_$2184);
		}
	}
	...
	{
		return new TaskListScript.$UpdateTaskInfo$2178(this).GetEnumerator();
	}
