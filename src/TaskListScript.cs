...
public class TaskListScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $UpdateTaskInfo$3109 : GenericGenerator<WWW>
	{
		internal TaskListScript $self_$3115;

		public $UpdateTaskInfo$3109(TaskListScript self_)
		{
			this.$self_$3115 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new TaskListScript.$UpdateTaskInfo$3109.$(this.$self_$3115);
		}
	}
	...
	{
		return new TaskListScript.$UpdateTaskInfo$3109(this).GetEnumerator();
	}
