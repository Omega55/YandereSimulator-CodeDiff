...
public class TaskListScript : MonoBehaviour
{
	[CompilerGenerated]
	[Serializable]
	internal sealed class $UpdateTaskInfo$3115 : GenericGenerator<WWW>
	{
		internal TaskListScript $self_$3121;

		public $UpdateTaskInfo$3115(TaskListScript self_)
		{
			this.$self_$3121 = self_;
		}

		public override IEnumerator<WWW> GetEnumerator()
		{
			return new TaskListScript.$UpdateTaskInfo$3115.$(this.$self_$3121);
		}
	}
	...
	{
		return new TaskListScript.$UpdateTaskInfo$3115(this).GetEnumerator();
	}
