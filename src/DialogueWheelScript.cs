...
public class DialogueWheelScript : MonoBehaviour
{
	...
	public virtual void HideShadows()
	{
		...
		if (PlayerPrefs.GetInt(this.Yandere.TargetStudent.StudentID + "_Friend") == 0)
		{
			if (this.Yandere.TargetStudent.StudentID != 6 && this.Yandere.TargetStudent.StudentID != 7 && this.Yandere.TargetStudent.StudentID != 13 && this.Yandere.TargetStudent.StudentID != 14 && this.Yandere.TargetStudent.StudentID != 15 && this.Yandere.TargetStudent.StudentID != 32)
			{
				float a8 = 0.75f;
