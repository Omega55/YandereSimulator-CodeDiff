...
public class YanvaniaWineScript : MonoBehaviour
{
	...
	private void Update()
	{
		if (base.transform.parent == null)
		{
			...
			{
				Object.Instantiate<GameObject>(this.Shards, new Vector3(base.transform.position.x, 6.5f, base.transform.position.z), Quaternion.identity).transform.localEulerAngles = new Vector3(-90f, 0f, 0f);
